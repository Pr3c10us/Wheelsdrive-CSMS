                    ...
                    <tbody className="divide-y text-center divide-gray-200">
                        <tr>
                            ...
                            <td className="whitespace-nowrap px-4 py-4 font-medium flex text-text gap-x-2">
                                <button className="flex gap-x-2 h-10 flex-1  bg-gray-200 transition-all duration-20 w-24 py-2 px-2 rounded items-center justify-center"></button>
                                <button className="flex gap-x-2 h-10 flex-1  bg-gray-200 w-24 py-2 px-2 rounded items-center justify-center"></button>
                            </td>
                        </tr>
                        <tr>
                            <td className="whitespace-nowrap px-4 py-4 font-medium text-text">
