...
const CreateFormModal = ({ openForm, setOpenForm, handleRefresh }) => {
    ...
    const formik = useFormik({
        ...
        onSubmit: (values, { setSubmitting }) => {
            ...
            axios
                .post(`${process.env.NEXT_PUBLIC_API_URL}rfid`, rfid)
                .then((data) => {
                    setOpenForm(false);
                    handleRefresh();
                })
        ...
        validationSchema: Yup.object({
            ...
            year: Yup.string(" ")
                ...
                .required(" "),
            name: Yup.string().required("Please fill out ApiUser name"),
            rfid: Yup.string().required("Please fill out ApiUser rfid"),
            parentRFID: Yup.string().required(
                "Please fill out ApiUser parentRFID"
            ),
        }),
    });
